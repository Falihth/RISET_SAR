/*
  Dari riset yang kami lalukan, kode ini berhubungan dengan bagaimana kaki robot melakukan gerak.
  Ada trajektori dan gait pattern yang digunakan untuk robot bergerak.
  Ada 2 gait pada robot ini yaitu Tripod dan Ripple. lebih lanjut bisa searching di google
  Kami sarankan juga untuk melakukan riset lebih lanjut pada file ini.
*/
...
float gait_pattern(byte sn, byte s)
{
  ...
  if (s <= q1)
    gaitPattern[s] = (s - q3) * perStep / q3;
  if (s > q1)
    gaitPattern[s] = (-s + q4) * perStep / q3;
