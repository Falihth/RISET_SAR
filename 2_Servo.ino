/*
  Kode pada file ini digunakan untuk inisialisasi Servo ke 6 kaki dan tangan gripper.
*/
...
void activeServo()
{
  ...
  else
  {
    ...
    for (byte fn = 1; fn <= 6; fn++)
    {
      sCoxa[fn].attach(coxaPin[fn]);
      delay(50);
      sFemur[fn].attach(femurPin[fn]);
      delay(50);
      sTibia[fn].attach(tibiaPin[fn]);
      delay(50);
      dinamicMovement(fn);
      delay(50);
    }
