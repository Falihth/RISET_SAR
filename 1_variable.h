/*
  File ini digunakan untuk mendefinisikan setiap variable yang digunakan

  Terdapat variable penting yang digunakan untuk menjalankan robot (line 40)!
*/
...
// Ini merupakan variable penting yang digunakan dalam melakukan riset robot!
float in_px = 0;    // nilai - robot melangkah miring ke kiri; nilai + ke kanan
float in_py = 0;    // nilai - badan robot (ground clearence) naik ke atas; nilai + turun ke bawah
float in_pz = 0;    // nilai - robot melangkah maju; nilai + ke mundur
float in_yaw = 0;   // nilai - putar ke kiri; nilai + ke kanan pada sumbu Z
float in_pitch = 0; // nilai - putar ke muka; nilai + ke belakang pada sumbu Y
float in_roll = 0;  // nilai - putar ke kiri; nilai + ke kanan pada sumbu X
float in_lift = 10; // Tinggi robot dalam mengangkat kaki
float in_speed = 2; // Power/Speed robot dalam melangkah
